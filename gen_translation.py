...
def _generate_en_():
    en_data = {
        ...
        "main.debug.chunk_pos": "chunk:{chunkposx},{chunkposy}",
...
def _generate_jp_():
    jp_data = {
        ...
        "game.title": "穴掘りゲーム",
        "menu.title": "メニュー",
        "menu.sound_effects": "効果音",
        "menu.music": "音楽",
        "menu.language": "言語",
        "button.title_screen.start.default": "スタート",
        "button.title_screen.start.pressed": "クリック！",
        "button.menu.save.default": "セーブ",
        "button.menu.load.default": "ロード",
        "button.menu.quit.default": "ゲーム終了",
        "button.menu.save.pressed": "セーブ中...",
        ...
        "main.debug.block_count": "blk:{blk_count}",
        "main.debug.particle_count": "pcl:{pcl_count}",
        "notification.save.success.default": "ゲームを保存しました",
        "notification.save.error.write.default": "セーブ失敗: ファイルに書き込めませんでした.",
        "notification.save.error.unexpected.default": "セーブ失敗: 予期せぬエラーが発生しました",
        "notification.load.success.default": "ゲームをロードしました",
        "notification.load.error.not_found.default": "セーブファイルが見つかりません",
        "notification.load.error.decode.default": "ロード失敗: 無効なJSON形式です",
        "notification.load.error.unexpected.default": "ロード失敗: 予期せぬエラーが発生しました",
        "notification.save.success.debug": "ゲームを {filename} に保存しました",
        "notification.save.error.write.debug": "セーブエラー: {filename} に書き込めませんでした。 {error}",
        "notification.save.error.unexpected.debug": "予期せぬセーブエラーが発生しました: {error}",
        "notification.load.success.debug": "{filename} からゲームをロードしました",
        "notification.load.error.not_found.debug": "セーブファイルが見つかりません: {filename}",
